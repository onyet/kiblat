            ...
            children: [
              ...
              SizedBox(
                ...
                child: Material(
                  ...
                  child: Ink(
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(colors: [Color(0xFFD4AF37), Color(0xFFF4C025)]),
                      borderRadius: BorderRadius.circular(16),
                    ),
                    child: InkWell(
                      borderRadius: BorderRadius.circular(16),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text(tr('get_started'), style: const TextStyle(color: Colors.black, fontWeight: FontWeight.w800)),
                            const SizedBox(width: 8),
